...
public class PreViewWindow{
    ...
    private HashMap<String, ArrayList<Course>> defaultCourses;
     ...
     * @param hashMap 
     */
    public PreViewWindow(ArrayList<Course> courses, HashMap<String, ArrayList<Course>> hashMap){
        this.coursesList = new ArrayList<>(courses); 
        this.defaultCourses = new HashMap<String, ArrayList<Course>> (hashMap);
    ...
    public void createFrameAndTables(){
                ...
                || typeOfDegreePlan.equals(SYSTEMS) || typeOfDegreePlan.equals(TRADITIONAL_COMPUTER_SCIENCE)) 
        {
            ...
            {
                tablePanels[ix] = createTablePanel(numberOfTables, tableFlag, intFlag, ix); // Method call 
                tableFlag++;
            }
    ...
    public JPanel createTablePanel(int numOfTables, int tableFlag, int intFlag, int degreePlanSection){
        ...
        TableModel model = new TableModel(numOfTables, tableFlag, typeOfDegreePlan, defaultCourses, coursesList); // Create instance of TableModel. TableModel is used to 
